...
ActiveRecord::Schema[7.2].define(version: 2026_08_26_094525) do
  ...
  create_table "monthly_user_reputations", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["period", "user_id"], name: "index_monthly_user_reputations_on_period_and_user_id", unique: true
    t.index ["period"], name: "index_monthly_user_reputations_on_period"
    t.index ["user_id"], name: "index_monthly_user_reputations_on_user_id"
  end
  ...
  add_foreign_key "monthly_user_reputations", "users"
