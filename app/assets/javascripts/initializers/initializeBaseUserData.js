...
if (reportButton) {
  reportButton.style.display = "none"; // Hide the Report button if the Author is viewing its own post
      ...
      if (published === true && !scheduled) {
        actions.push(
          `<a class="crayons-btn crayons-btn--s crayons-btn--ghost px-2" id ="article-action-space-manage" href="${articleContainer.dataset.path}/manage" rel="nofollow">Управління</a>`,
        );
      }
