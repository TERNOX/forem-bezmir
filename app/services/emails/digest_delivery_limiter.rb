module Emails
  class DigestDeliveryLimiter
    ...
    TEST_NEXT_SLOT_KEY = "email_digest/next_test_delivery_slot".freeze
    ...
    def self.call(reserved_at: nil, not_before: nil, priority: false)
      # Interactive previews have their own reservations, but share the actual
      # SMTP guard with bulk deliveries so they cannot exceed the sender rate.
      next_slot_key = priority ? TEST_NEXT_SLOT_KEY : NEXT_SLOT_KEY
