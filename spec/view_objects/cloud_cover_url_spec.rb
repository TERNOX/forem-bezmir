...
RSpec.describe CloudCoverUrl, cloudinary: true, type: :view_object do
  ...
  it "returns proper url" do
    expect(described_class.new(article.main_image).call)
      ...
      .and include("/c_fill,f_auto,fl_progressive,h_520,q_auto,w_1200/https://robohash.org/")
  end

  it "returns proper url when nested cloudinary" do
    image_url = "https://res.cloudinary.com/practicaldev/image/fetch/s--A-gun7rr--/c_imagga_scale,f_auto,fl_progressive,h_520,q_auto,w_1200/https://res.cloudinary.com/practicaldev/image/fetch/s--hcD8ZkbP--/c_imagga_scale%2Cf_auto%2Cfl_progressive%2Ch_420%2Cq_auto%2Cw_1000/https://dev-to-uploads.s3.amazonaws.com/i/th93d625o27nuz63oeen.png" # rubocop:disable Layout/LineLength
    cloudinary_string = "/c_fill,f_auto,fl_progressive,h_520,q_auto,w_1200/https://dev-to-uploads.s3.amazonaws.com/i/th93d625o27nuz63oeen.png" # rubocop:disable Layout/LineLength
  ...
  it "returns proper url when config set to limit" do
    ...
    expect(described_class.new(article.main_image).call)
      .to start_with(cloudinary_prefix)
      .and include("/c_limit,f_auto,fl_progressive,h_520,q_auto,w_1200/https://robohash.org/")
  end
  ...
  it "returns proper url when a subforem_id is set" do
    ...
    expect(described_class.new(article.main_image, subforem_id).call)
      .to start_with(cloudinary_prefix)
      .and include("/c_limit,f_auto,fl_progressive,h_450,q_auto,w_1200/https://robohash.org/")
  end
  ...
  it "returns proper url when height is set" do
    ...
    expect(described_class.new(article.main_image).call)
      .to start_with(cloudinary_prefix)
      .and include("/c_fill,f_auto,fl_progressive,h_902,q_auto,w_1200/https://robohash.org/")
  end
  ...
  it "returns proper url when ytimg.com is used" do
    ...
    expect(described_class.new(article.main_image).call)
      .to start_with(cloudinary_prefix)
      .and include("/c_fill,f_auto,fl_progressive,h_500,q_auto,w_1200/https://i.ytimg.com/vi/some_video_id/maxresdefault.jpg")
  end
end
