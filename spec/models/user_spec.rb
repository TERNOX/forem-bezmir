...
RSpec.describe User do
  ...
  describe "theming properties" do
    ...
    it "creates proper body class with defaults" do
      ...
      classes = "system-theme-preference sans-serif-article-body mod-status-#{user.admin? || !user.moderator_for_tags.empty?} trusted-status-#{user.trusted?} #{user.setting.config_navbar}-header"
    ...
    it "creates proper body class with open dyslexic config" do
      ...
      # rubocop:disable Layout/LineLength
      classes = "system-theme-preference open-dyslexic-article-body mod-status-#{user.admin? || !user.moderator_for_tags.empty?} trusted-status-#{user.trusted?} #{user.setting.config_navbar}-header"
      # rubocop:enable Layout/LineLength
      expect(user.decorate.config_body_class).to eq(classes)
    end
