...
RSpec.describe YoutubeTag, type: :liquid_tag do
  describe "#id" do
    ...
    it "accepts an embed URL on youtube-nocookie.com" do
      result = generate_tag("https://www.youtube-nocookie.com/embed/#{valid_id}")
    ...
    it "includes recommended iframe attributes" do
      result = Liquid::Template.parse("{% youtube #{valid_id} %}").render
